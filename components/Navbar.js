...
const Navbar = () => {
  return (
    <>
      <nav className="w-[90vw]  fixed left-[5vw]  top-[50px] h-[50px] bg-[#FFFFFF] py-10 mx-auto rounded-full  flex items-center justify-between ">
        <div className="flex gap-20 ml-[2vw] items-center">
          <Link href="/">
            <svg
              className="h-5 ml-2"
          ...
          <ul className="flex ">
            <li className="font-medium hover:bg-gray-100 duration-300 ease-in-out px-4 py-3 rounded-md text-[#1E2330]">
              Products
            </li>
            <li className="font-medium hover:bg-gray-100 duration-300 ease-in-out px-4 py-3 rounded-md text-[#1E2330]">
              Templates
        ...
        <div className="flex gap-2 mr-4">
          <SignedOut>
            <SignInButton>
              <button className="px-7 py-4 bg-[#E9E9E9] font-semibold rounded-lg">
                Log in
              </button>
            </SignInButton>
            <SignUpButton>
              <button className="px-7 py-4 text-white bg-[#1E2330] font-semibold rounded-full">
                Sign up free
              </button>
            </SignUpButton>
          </SignedOut>
